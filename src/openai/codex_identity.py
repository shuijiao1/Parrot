...
from . import codex_identity_projection as _projection
...
def project_snapshot(
    ...
    *,
    ...
    return _projection.project_snapshot(
        snapshot,
        headers,
        payload,
        direct_installation_header=direct_installation_header,
        create_client_metadata=create_client_metadata,
        identity_error=CodexIdentityError,
    )
...
def capture_turn_state(
    ...
    return _projection.capture_turn_state(
        translator_ctx,
        headers,
        request_context_type=RequestIdentityContext,
        snapshot_type=RequestIdentitySnapshot,
    )
